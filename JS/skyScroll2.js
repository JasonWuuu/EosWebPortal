    ...
    skyScroll.prototype = {
        ...
        init: function (opts) {
            var set = _extend({
                ...
                dir: 'top',
                width: 270,
                height: getClientSize().height-80,
                callback: function () { }
            }, opts || {});
        ...
        recalculated: function () {
            ...
            if (this.vScroll) {
                h = Math.round(Math.pow(this.height, 2) / (2*H));
        ...
        addVscroll: function () {
            ...
            this.vScrollOuter = _createEl('<div class="sky_scrollTopOuter" style="position:absolute;top:0;right:4px;height:' + this.height + 'px;overflow:hidden"></div>', this.wrapper)
            this.vScroll = _createEl('<div class="sky_scrollTop" style="position:absolute;top:0;right:2px;"></div>', this.wrapper);
            this.recalculated();
        },
        //对外提供添加横向滚动条的方法
        addLscroll: function () {
